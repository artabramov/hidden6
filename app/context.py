...
# - request_start_time: timestamp when request processing started
# - request_uuid: identifier of the current request
# - current_user_id: identifier of the current user

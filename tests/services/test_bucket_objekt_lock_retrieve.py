# tests/services/test_bucket_objekt_lock_retrieve.py
...
from app.services.bucket_objekt_lock_retrieve import (  # noqa: E402
...
class TestBucketObjektLockRetrieve(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_returns_bucket_when_object_lock_enabled(self):
        ...
        with (
            patch(
                "app.services.bucket_objekt_lock_retrieve.ORMRepository",
                return_value=repo,
            ),
            patch(
                "app.services.bucket_objekt_lock_retrieve.load_bucket",

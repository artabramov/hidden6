# tests/schemas/test_gocryptfs_passphrase.py
...
class TestGocryptfsPassphraseRequest(unittest.TestCase):

    def test_accepts_valid_master_password(self):
        req = GocryptfsPassphraseRequest(
...
class TestGocryptfsPassphraseResponse(unittest.TestCase):

    def test_accepts_passphrase(self):
        resp = GocryptfsPassphraseResponse(
